...
function parse(input) {
    ...
    let i = 0
    const threshold = (isMainInput) ? 1024 : 12
...
/**
 * Finds the shortest path. This should be called after the initial blocks have
 * fallen.
 */
function traverse() {
    let score = Infinity
...
function solve(input) {
    ...
    console.log("After %d KB fall, the shortest path takes %d steps.", threshold, output)
}
